     ...
     2    0.0D0,0.5D0,1.0D0,2.0D0,3.0D0,1.D-06/
      DATA MXITER / 50 /
 1000 FORMAT(/'IIter',15X,'S_eff',9X,'SigmaY',10X,'Eps_p',12X,'PHI')
 2000 FORMAT(/,I5,5X,G15.4,G15.4,G15.4,G15.4)
 3000 FORMAT(/'STRAINP0: ',G15.4)
      WRITE(16,3000) RSTAVA(MSTRE+1)
      WRITE(16,1000)
C***********************************************************************
...
C -------------------------------------------------------------------
        IFPLAS=.TRUE.
        EPBAR=EPBARN
        WRITE(16,2000) 0,QTRIAL,SIGMAY,EPBAR,PHI
...
C Check convergence
          ...
          WRITE(16,2000) NRITER,QTRIAL-R3G*DGAMA,SIGMAY,EPBAR,PHI
